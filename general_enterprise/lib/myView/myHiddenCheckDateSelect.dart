...
class MyHiddenCheckDateSelect extends StatefulWidget {
  MyHiddenCheckDateSelect(
      ...
      this.width,
      this.height,
      this.icon, this.dateTime, this.hintText, this.borderColor, this.minDateTime, this.maxDateTime
  });
  final title,
      purview,
      value,
  ...
  @override
  _MyHiddenCheckDateSelectState createState() => _MyHiddenCheckDateSelectState();
}

class _MyHiddenCheckDateSelectState extends State<MyHiddenCheckDateSelect> {
  String msg = '';
  int clickNum = 0;
  String place;
  DateTime dateTime;
    ...
    showModalBottomSheet(
        ...
        builder: (_) => Container(
            ...
            child: DateTimePickerWidget(
                ...
                minDateTime: widget.minDateTime!= null ? widget.minDateTime : null,
                maxDateTime: widget.maxDateTime!= null ? widget.maxDateTime : null,
