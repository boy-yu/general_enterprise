...
class _MyOverviewState extends State<MyOverview> {
  ...
  _getMyTaskStatistics() {
    myDio
      ...
      url: Interface.getMyTaskStatistics,
        ...
        .then((value) {
      if (value is Map) {
        myTask[0]['num'] = value['total'] == 0
            ? '0'
            : (value['checked'] / value['total'] * 100)
                .toStringAsFixed(1)
                .toString();
  ...
  _getMyHiddenDangerTreatmentSituation() {
    myDio
      ...
      if (value is Map) {
        ...
        hisControlhiddenPie.add(PieSturct(
            color: Color(0xff2276FC),
            nums: value['confirmed'] * 1.0,
            title: '已确认'));
        hisControlhiddenPie.add(PieSturct(
            color: Color(0xffF56271),
            nums: value['liable'] * 1.0,
            title: '已整改'));
        hisControlhiddenPie.add(PieSturct(
            color: Color(0xffFFCA0E),
            nums: value['accept'] * 1.0,
            title: '已验收'));
  ...
  Map hisControlhiddenMap = {"liable": 0, "confirmed": 0, "accept": 0};
  ...
  Map unitOperationEffectMap = {"four": 0, "one": 0, "two": 0, "three": 0};
          ...
          child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '隐患等级：' +
                        (waitGovernList[i]['dangerLevel'] == 0
                            ? '重大隐患'
                            : '一般隐患'),
                    style: TextStyle(
                        color: Colors.white,
                  ...
                  Text(
                    '隐患治理期限：' +
                        DateTime.fromMillisecondsSinceEpoch(
                                waitGovernList[i]['dangerManageDeadline'])
                            .toString()
                            .substring(0, 19),
                    style: TextStyle(
                        color: Colors.white,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder:
                                      (context, checkListStatisticsIndex) {
                                    return Column(
                                      children: [
                                        Padding(
                                          padding: EdgeInsets.symmetric(
