...
class ProductDeliveryRecord extends StatefulWidget {
  ProductDeliveryRecord({this.id});
  final int id;
  @override
  _ProductDeliveryRecordState createState() => _ProductDeliveryRecordState();
}

class _ProductDeliveryRecordState extends State<ProductDeliveryRecord> {
  DateTime startDate;
  DateTime endDate;
  ...
  _getDate(){
    myDio.request(
      type: 'get', 
      url: Interface.getWarehousingShippmentRecordById, 
      queryParameters: {
        'id': widget.id,
    }).then((value) {
      data = value;
