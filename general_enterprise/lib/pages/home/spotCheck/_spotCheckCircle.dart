...
class SpotCheckCircle extends StatefulWidget {
  final double width;
  final double sizes;
  final double radius;
  final double fontsize;

  final int initialSpotCheckLevel;
  final int value;
  final int level;
  final String text;
  const SpotCheckCircle(
      {Key key,
      @required this.width,
      this.sizes,
      this.value,
      ...
      this.radius,
      this.fontsize,
      this.initialSpotCheckLevel,
      this.text})
      : super(key: key);
  @override
  _SpotCheckCircleState createState() => _SpotCheckCircleState();
}
...
class _SpotCheckCircleState extends State<SpotCheckCircle> {
  @override
    ...
    return CustomPaint(
      child: Container(
          ...
          decoration: BoxDecoration(
            color: _getColor(widget.initialSpotCheckLevel),
