...
class AppendEventDialog extends StatefulWidget {
  AppendEventDialog({this.callback});
  final Function callback;
  @override
  _AppendEventDialogState createState() => _AppendEventDialogState();
}

class _AppendEventDialogState extends State<AppendEventDialog> {
                            ...
                            children: <Widget>[
                              GestureDetector(
                                onTap: () {
                                  ...
                                  }else if(_controller.text == null || _controller.text == ''){
