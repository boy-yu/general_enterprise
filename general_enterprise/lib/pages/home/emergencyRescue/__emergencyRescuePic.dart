...
class EmergencyRescuePic extends StatefulWidget {
  @override
  _EmergencyRescuePicState createState() => _EmergencyRescuePicState();
}

class _EmergencyRescuePicState extends State<EmergencyRescuePic> {
    ...
    return MyAppbar(
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              right: size.width * 40,
              bottom: size.width * 180,
              child: InkWell(
                onTap: () {
                  // print('object');
                  // Navigator.pushNamed(
                  //     context, '/emergencyRescue/rescuePicNext');
                  Navigator.pushNamed(
                      context, '/emergencyRescue/__emergencyRescueExpert');
                },
                child: Container(
                  padding: EdgeInsets.all(size.width * 10),
                  color: Colors.white,
                  child: Image.asset(
                    'assets/images/emergencyRescue_next@2x.png',
                    width: size.width * 46,
