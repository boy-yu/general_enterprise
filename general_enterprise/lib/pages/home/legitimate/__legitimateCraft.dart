...
class LegitimateCraft extends StatefulWidget {
  @override
  _LegitimateCraftState createState() => _LegitimateCraftState();
}

class _LegitimateCraftState extends State<LegitimateCraft> {
  @override
...
class CraftTitleCard extends StatefulWidget {
  @override
  _CraftTitleCardState createState() => _CraftTitleCardState();
}

class _CraftTitleCardState extends State<CraftTitleCard> {
  List menuList = [];
  @override
  void initState() {
    super.initState();
  ...
  _getTitleFile() {
    myDio.request(
        ...
        queryParameters: {"type": 8}).then((value) {
      if (value != null) {
...
class _CraftListState extends State<CraftList> {
  ...
  @override
  void didUpdateWidget(CraftList oldWidget) {
  ...
  _getDate() {
    myDio.request(
        ...
        queryParameters: {"type": 4}).then((value) {
      if (value is List) {
        data = value;
      }
      if (mounted) {
