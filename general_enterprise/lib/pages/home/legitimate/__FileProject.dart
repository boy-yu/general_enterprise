...
class FileProject extends StatefulWidget {
  @override
  _FileProjectState createState() => _FileProjectState();
}

class _FileProjectState extends State<FileProject> {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        FileProjectTitleCard(),
        Expanded(
          child: FileProjectList(),
        )
      ],
    );
  }
...
class FileProjectTitleCard extends StatefulWidget {
  @override
  _FileProjectTitleCardState createState() => _FileProjectTitleCardState();
}

class _FileProjectTitleCardState extends State<FileProjectTitleCard> {
  List menuList = [];
  @override
  void initState() {
    super.initState();
  ...
  _getTitleFile() {
    myDio.request(
        ...
        queryParameters: {"type": 6}).then((value) {
      if (value != null) {
...
class FileProjectList extends StatefulWidget {
  @override
  _FileProjectListState createState() => _FileProjectListState();
}

class _FileProjectListState extends State<FileProjectList> {
  List data = [];
  ...
  @override
  void didUpdateWidget(FileProjectList oldWidget) {
