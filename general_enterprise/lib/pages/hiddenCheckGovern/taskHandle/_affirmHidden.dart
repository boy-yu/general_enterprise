                ...
                child: Padding(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(color: Color(0xFFECECEC), width: size.width * 2),
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          contentPadding: EdgeInsets.only(bottom: size.width * 20, left: size.width * 20),
                            border: InputBorder.none,
                            hintStyle: TextStyle(
                            ...
                            GestureDetector(
                                      ...
                                      builder: (BuildContext context) {
                                        return ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            return InkWell(
                                              onTap: () {
                                                fiveMeasuresData['dangerLevel'] = levelList[index]['id'].toString();
                                                setState(() {});
                                                Navigator.pop(context);
                                              },
                                              child: ListTile(
                                                title: Text(
                                                    levelList[index]['name'].toString()),
                                              ),
                                            );
                                          },
                                        );
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      fiveMeasuresData['dangerLevel'] == '' ? "请选择" : fiveMeasuresData['dangerLevel'] == '0' ? '一般隐患' : '重大隐患',
                                      style: TextStyle(
                            ...
                            GestureDetector(
                              onTap: (){
                                showModalBottomSheet(
                                      ...
                                      builder: (BuildContext context) {
                                        return ListView.builder(
                                          itemCount: hazardDangerTypeList.length,
                                          itemBuilder: (context, index) {
                                            return InkWell(
                                              onTap: () {
                                                fiveMeasuresData['hazardDangerType'] = hazardDangerTypeList[index]['id'].toString();
                                                setState(() {});
                                                Navigator.pop(context);
                                              },
                                              child: ListTile(
                                                title: Text(
                                                    hazardDangerTypeList[index]['name'].toString()),
                                              ),
                                            );
                                          },
                                        );
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      fiveMeasuresData['hazardDangerType'] == '' ? "请选择" : _getHazardDangerType(fiveMeasuresData['hazardDangerType'] ),
                                      style: TextStyle(
                                        color: Color(0xff7F8A9C),
                                        fontSize: size.width * 28,
                                        fontWeight: FontWeight.w400
                    ...
                    GestureDetector(
                                      ...
                                      builder: (BuildContext context) {
                                        return ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            return InkWell(
                                              onTap: () {
                                                fiveMeasuresData['dangerSrc'] = dangerSrcList[index]['id'].toString();
                                                setState(() {});
                                                Navigator.pop(context);
                                              },
                                              child: ListTile(
                                                title: Text(
                                                    dangerSrcList[index]['name'].toString()),
                                              ),
                                            );
                                          },
                                        );
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      fiveMeasuresData['dangerSrc'] == '' ? "请选择" : _getDangerSrc(fiveMeasuresData['dangerSrc'] ),
                                      style: TextStyle(
                                        color: Color(0xff7F8A9C),
                                        fontSize: size.width * 28,
                                        fontWeight: FontWeight.w400
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          contentPadding: EdgeInsets.only(bottom: size.width * 20, left: size.width * 20),
                            ...
                            hintStyle: TextStyle(
                                fontSize: size.width * 28, color: Color(0xff7F8A9C)),
                            hintText: fiveMeasuresData['controlMeasures'] == ''
                                ? '请输入控制措施'
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              height: size.width * 75,
                              width: size.width * 310,
                              margin: EdgeInsets.only(top: size.width * 16, bottom: size.width * 16),
                              decoration: BoxDecoration(
                                border: Border.all(color: Color(0xFFECECEC), width: size.width * 2),
                                borderRadius: BorderRadius.all(Radius.circular(size.width * 8))
                              ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            MyDateSelect(
                              ...
                              hintText: '隐患治理期限',
                              callback: (value) {
                                fiveMeasuresData['dangerManageDeadline'] = value;
                              },
                              icon: Image.asset(
