...
class _ReformAcceptState extends State<ReformAccept> {
  Map data = {
    ...
    'reformOpinion': '整改意见整改意见整改意见整改意见整改意见',
    'reformUrl': 'http://171.91.196.161:31010/2022-04-25/16508788624301650878859864.png',
  };
    ...
    return Container(
        ...
        child: SingleChildScrollView(
          ...
          Container(
            ...
            height: size.width * 200,
            child: Wrap(
                children: data['reformUrl'].split('|').map<Widget>((ele) {
              return Padding(
                padding: EdgeInsets.only(right: size.width * 10),
                child: ele.toString().indexOf('http') > -1
                    ? Image.network(
            ...
            child: Row(
              ...
              child: Container(
                ...
                child: Text(
                  '驳  回',
                  style:
                      TextStyle(color: Color(0xffF56271), fontSize: size.width * 32, fontWeight: FontWeight.w500),
                ),
              ),
            ),
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text(
                  '确  定',
                  style:
                      TextStyle(color: Colors.white, fontSize: size.width * 32, fontWeight: FontWeight.w500),
                ),
              ),
            ),
              ],
